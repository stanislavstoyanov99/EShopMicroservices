...
namespace Ordering.Infrastructure.Data.Configurations
{
    public class OrderConfiguration : IEntityTypeConfiguration<Order>
    {
        public void Configure(EntityTypeBuilder<Order> builder)
        {
            ...
            builder
                .ComplexProperty(o => o.Name, nameBuilder =>
                {
                    nameBuilder
                        .Property(n => n.Value)
            ...
            builder
                .ComplexProperty(o => o.BillingAddress, billingAddressBuilder =>
                {
                    billingAddressBuilder
                        .Property(ba => ba.FirstName)
                        .HasMaxLength(50)
                        .IsRequired();

                    billingAddressBuilder
                        .Property(ba => ba.LastName)
                        .HasMaxLength(50)
                        .IsRequired();

                    billingAddressBuilder
                        .Property(ba => ba.EmailAddress)
                        .HasMaxLength(50);

                    billingAddressBuilder
                        .Property(ba => ba.AddressLine)
                        .HasMaxLength(180)
                        .IsRequired();

                    billingAddressBuilder
                        .Property(ba => ba.Country)
                        .HasMaxLength(50);

                    billingAddressBuilder
                        .Property(ba => ba.State)
                        .HasMaxLength(50);

                    billingAddressBuilder
                        .Property(ba => ba.ZipCode)
                        .HasMaxLength(5)
                        .IsRequired();
                });
